...
function getListGameByCat($conn, $cat, $page) { // input to game_page
    ...
    $el_link = $xpath->query('//a[@class="css-rb4bgf"]');
...
function myParseContent($conn, $page, $cat, $thumb) {
    ...
    saveDB($conn, $title, $s_title, 'HTML5', $vote, $vote_time, $play_time, $link, 'https://crazygames.com', $author, $cat, 0, 0, 0, 0, $desc, $guide, $thumb);
