...
function saveDB($conn, $title, $t_slug, $type, $vote, $vote_time, $play_time, $hot, $link, $site, $author, $cat1, $cat2, $cat3, $cat4, $g_not_mobi, $desc, $guide, $thumb, $allow_embed) {
        $sql = "INSERT INTO game (
            ...
            updated_at,
            deleted_at)
    VALUES ('".$title."', '".$t_slug."', '".$type."', ".$vote.", ".$vote_time.", ".$play_time.", ".$hot.", '".$link."', '".$site."', 'en', '".$author."', '".$cat1."', '".$cat2."', '".$cat3."', '".$cat4."', '".$g_not_mobi."', '".$desc."', '".$guide."', '".$thumb."', ".$allow_embed.", 1, NOW(), NOW(), null)";
